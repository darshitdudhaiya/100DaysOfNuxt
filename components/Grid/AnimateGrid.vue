<template>
  <div :class="cn('relative hidden xl:block m-3', props.class)">
    <div
      :class="
        cn(
...
.grid-transform:before {
  ...
  width: 150%;
  height: 120%;
  background: radial-gradient(circle, #d9fbe8 0%, rgb(141, 113, 113) 70%, transparent 100%);
  opacity: 0.5;
}
...
.card-raised-big {
  ...
  background-color: rgba(23, 69, 11, 0.575);
