<template>
  <div class="flex flex-col items-start gap-4">
    <!-- Simple Loading Demo -->
    <!-- <section class="text-white flex w-full flex-col items-center justify-center">
      <h2 class="mb-2 text-lg font-semibold">
        Simple Loading Demo (prevent close)
      </h2>
      <MultistepLoaderVue
      ...
      />
      <UiButton class="mt-4 bg-white text-black p-3 rounded-lg shadow-lg border-black " @click="toggleSimpleLoading">
    ...
    <!-- Async Loading Demo -->
    <section class="text-white flex w-full flex-col items-center justify-center">
      <h2 class="mb-2 text-2xl font-semibold">Async Loading Demo</h2>
      <MultistepLoaderVue
      ...
      />
      <UiButton
        class="mt-4 bg-white text-black p-3 rounded-lg shadow-lg border-black cursor-pointer"
...
import MultistepLoaderVue from "~/components/MultiStep-Loader/MultistepLoader.vue";
...
async function startAsyncLoading() {
  ...
  function simulateAsyncStep(
    stateProp: keyof typeof loaderStates,
    delay: number
  ) {
